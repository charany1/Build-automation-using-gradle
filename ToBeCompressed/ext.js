...
function onLoaded() {
    ...
    var appNames = ["ILST","PHXS","FLPR","PRLD","IDSN","PPRO"];
    ...
    var appUILocale = csInterface.hostEnvironment.appUILocale;
    var thisOS = csInterface.getOSInformation();
    updateLocaleTexts(appName, appUILocale, thisOS, csInterface.hostEnvironment.appSkinInfo);
    updateThemeWithAppSkinInfo(csInterface.hostEnvironment.appSkinInfo);
    // Update the color of the panel when the theme color of the product changed.
    csInterface.addEventListener(CSInterface.THEME_COLOR_CHANGED_EVENT, onAppThemeColorChanged);
    //launchCommand('getUserDtls', 'true');
    if(appName !== "AEFT"){
...
function updateThemeWithAppSkinInfo(appSkinInfo) {
	...
	if(appName == "PHXS" || appName == "PPRO" || appName == "PRLD" || appName == "ILST" || appName == "IDSN" || appName == "AEFT") {
		////////////////////////////////////////////////////////////////////////////////////////////////
		// NOTE: Below theme related code are only suitable for Photoshop, Ilustrator, InDesign, etc. //
	    ...
	    /*alert("appSkinInfo.baseFontFamily : "+appSkinInfo.baseFontFamily);*/
	    //alert("appSkinInfo.baseFontSize : "+appSkinInfo.baseFontSize);
	    //Update the default text style with pp values
	   /* if(appName == "PPRO")
	    	addRule(styleId, ".default", "font-size: 0.80em" + "; color:" + fontColor + "; background-color:" + toHex(panelBackgroundColor) + "; font-family:"+appSkinInfo.baseFontFamily);
	    else*/	
	    if(appSkinInfo.baseFontFamily && appSkinInfo.baseFontFamily != resourceBundle.SYS_FONT)
	    	addRule(styleId, ".default", "font-size:" + appSkinInfo.baseFontSize + "px" + "; color:" + fontColor + "; background-color:" + toHex(panelBackgroundColor) + "; font-family:"+appSkinInfo.baseFontFamily);
	    else
...
function toHex(color, delta) {
    ...
    if (color) {
        with (color) {
    		////////////////////////////////////////////////////////////////////////////////////////////////
    		// NOTE: Math.ceil() had to be added for the color codes as for apps like Illustrator,		  //     
        	// etc. the color codes returned are in decimals and the color is not set properly. 		  //
    		////////////////////////////////////////////////////////////////////////////////////////////////
